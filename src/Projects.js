            ...
            <Col xs="6">
              <Card className="project" style={{ backgroundColor: "white" }}>
                <CardBody>
                  ...
                  <CardText className="project-text">
                    A blogging app built using React and Redux. Incorporates
                    basic blogging functionalities, including adding, editing,
                    and deleting blog posts and blog post comments, as well as
                    up- and down-voting.
